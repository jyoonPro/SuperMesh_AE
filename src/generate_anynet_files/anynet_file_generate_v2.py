...
class Topology:
    ...
    def print_topology(self):
        ...
        anynet_filename = (self.args.topology + "_" + str(self.args.nodes) + "_"
                           + str(self.args.bandwidth) + "_v2.txt")
