...
class Topology:
    ...
    def print_topology(self):
        ...
        # In mesh, per flit latency is 20. Based on Kite paper, we get the latency 33. All the connectivities are also based on Kite paper.
        ...
        self.switch_to_switch[6].append((15, latency))

        self.switch_to_switch[7] = []
        self.switch_to_switch[7].append((6, latency))
        self.switch_to_switch[7].append((14, latency))

        self.switch_to_switch[8] = []
        self.switch_to_switch[8].append((1, latency))
        self.switch_to_switch[8].append((9, latency))

        self.switch_to_switch[9] = []
        self.switch_to_switch[9].append((0, latency))
        ...
        self.switch_to_switch[10].append((3, latency))
