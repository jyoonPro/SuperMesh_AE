...
class Topology:
    ...
    def print_topology(self):
        ...
        self.switch_to_switch[2].append((7, latency))

        self.switch_to_switch[3] = []
        self.switch_to_switch[3].append((2, latency))
        self.switch_to_switch[3].append((6, latency))
        self.switch_to_switch[3].append((7, latency))

        self.switch_to_switch[4] = []
        self.switch_to_switch[4].append((0, latency))
        self.switch_to_switch[4].append((1, latency))
        self.switch_to_switch[4].append((8, latency))
        self.switch_to_switch[4].append((9, latency))

        self.switch_to_switch[5] = []
        self.switch_to_switch[5].append((0, latency))
        self.switch_to_switch[5].append((2, latency))
        self.switch_to_switch[5].append((8, latency))
        self.switch_to_switch[5].append((10, latency))

        self.switch_to_switch[6] = []
        self.switch_to_switch[6].append((1, latency))
        self.switch_to_switch[6].append((3, latency))
        self.switch_to_switch[6].append((9, latency))
        self.switch_to_switch[6].append((11, latency))

        self.switch_to_switch[7] = []
        self.switch_to_switch[7].append((2, latency))
        self.switch_to_switch[7].append((3, latency))
        self.switch_to_switch[7].append((10, latency))
        self.switch_to_switch[7].append((11, latency))

        self.switch_to_switch[8] = []
        self.switch_to_switch[8].append((4, latency))
        self.switch_to_switch[8].append((5, latency))
        self.switch_to_switch[8].append((12, latency))
        self.switch_to_switch[8].append((13, latency))

        self.switch_to_switch[9] = []
        self.switch_to_switch[9].append((4, latency))
        self.switch_to_switch[9].append((6, latency))
        self.switch_to_switch[9].append((12, latency))
        self.switch_to_switch[9].append((14, latency))

        self.switch_to_switch[10] = []
        self.switch_to_switch[10].append((5, latency))
        self.switch_to_switch[10].append((7, latency))
        self.switch_to_switch[10].append((13, latency))
        self.switch_to_switch[10].append((15, latency))

        self.switch_to_switch[11] = []
        self.switch_to_switch[11].append((6, latency))
        self.switch_to_switch[11].append((7, latency))
        self.switch_to_switch[11].append((14, latency))
        self.switch_to_switch[11].append((15, latency))

        self.switch_to_switch[12] = []
        self.switch_to_switch[12].append((8, latency))
        self.switch_to_switch[12].append((9, latency))
        self.switch_to_switch[12].append((13, latency))

        self.switch_to_switch[13] = []
        self.switch_to_switch[13].append((8, latency))
