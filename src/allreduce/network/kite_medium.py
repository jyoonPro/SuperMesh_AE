...
class KiteMedium(Network):
    ...
    def build_graph(self):
        ...
        self.switch_to_switch[0].append((2, 1))
        self.switch_to_switch[0].append((8, 1))
        self.switch_to_switch[1] = []
        self.switch_to_switch[1].append((0, 1))
        self.switch_to_switch[1].append((3, 1))
        self.switch_to_switch[1].append((9, 1))
        self.switch_to_switch[1].append((6, 1))
        self.switch_to_switch[2] = []
        self.switch_to_switch[2].append((0, 1))
        self.switch_to_switch[2].append((3, 1))
        self.switch_to_switch[2].append((5, 1))
        self.switch_to_switch[2].append((10, 1))
        self.switch_to_switch[3] = []
        self.switch_to_switch[3].append((2, 1))
        self.switch_to_switch[3].append((1, 1))
        self.switch_to_switch[3].append((7, 1))
        self.switch_to_switch[3].append((11, 1))
        self.switch_to_switch[4] = []
        self.switch_to_switch[4].append((0, 1))
        self.switch_to_switch[4].append((5, 1))
        self.switch_to_switch[4].append((6, 1))
        self.switch_to_switch[4].append((12, 1))
        self.switch_to_switch[5] = []
        self.switch_to_switch[5].append((4, 1))
        self.switch_to_switch[5].append((13, 1))
        self.switch_to_switch[5].append((2, 1))
        self.switch_to_switch[5].append((7, 1))
        self.switch_to_switch[6] = []
        self.switch_to_switch[6].append((1, 1))
        self.switch_to_switch[6].append((4, 1))
        self.switch_to_switch[6].append((7, 1))
        self.switch_to_switch[6].append((14, 1))
        self.switch_to_switch[7] = []
        self.switch_to_switch[7].append((3, 1))
        self.switch_to_switch[7].append((5, 1))
        self.switch_to_switch[7].append((6, 1))
        self.switch_to_switch[7].append((15, 1))
        self.switch_to_switch[8] = []
        self.switch_to_switch[8].append((0, 1))
        self.switch_to_switch[8].append((9, 1))
        self.switch_to_switch[8].append((12, 1))
        self.switch_to_switch[8].append((10, 1))
        self.switch_to_switch[9] = []
        self.switch_to_switch[9].append((1, 1))
        self.switch_to_switch[9].append((11, 1))
        self.switch_to_switch[9].append((8, 1))
        self.switch_to_switch[9].append((14, 1))
        self.switch_to_switch[10] = []
        self.switch_to_switch[10].append((2, 1))
        self.switch_to_switch[10].append((8, 1))
        self.switch_to_switch[10].append((13, 1))
        self.switch_to_switch[10].append((11, 1))
        self.switch_to_switch[11] = []
        self.switch_to_switch[11].append((3, 1))
        self.switch_to_switch[11].append((9, 1))
        self.switch_to_switch[11].append((10, 1))
        self.switch_to_switch[11].append((15, 1))
        self.switch_to_switch[12] = []
        self.switch_to_switch[12].append((4, 1))
        self.switch_to_switch[12].append((14, 1))
        self.switch_to_switch[12].append((8, 1))
        self.switch_to_switch[12].append((13, 1))
        self.switch_to_switch[13] = []
        self.switch_to_switch[13].append((5, 1))
        self.switch_to_switch[13].append((15, 1))
        ...
        self.switch_to_switch[14].append((6, 1))
        self.switch_to_switch[14].append((12, 1))
        self.switch_to_switch[14].append((15, 1))
        self.switch_to_switch[15] = []
        self.switch_to_switch[15].append((11, 1))
        self.switch_to_switch[15].append((7, 1))
        self.switch_to_switch[15].append((14, 1))
        self.switch_to_switch[15].append((13, 1))
