...
//    DSENT DSENT::m_emeshInstance(string(getenv("BOOKSIMSRC")) + string("/dsent/configs/electrical-mesh.cfg"));
    ...
    DSENT* DSENT::createEMeshInstance(const string emesh_cfg_) {
        return new DSENT(String(emesh_cfg_));
    }
