...
void DSENTPower::calcMeshArea()
{
  DSENT::DSENT * dsent = _emesh_instance;
  dsent->evaluate();
  _active_area = dsent->queryResult("active_area");
  cout << "Active area: " << _active_area << endl;
