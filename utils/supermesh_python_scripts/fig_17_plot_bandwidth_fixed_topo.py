...
def draw_graph_ar(ax, schemes, names, folder_names, ldata, xlabels, total_nodes, folder_path, text_to_add, used_names, colors_dict, marker_colors_dict,markers_dict):
    ...
    for i in range(len(names)-1):
        ...
        highest_speedup = 0
        for d, data in enumerate(ldata):
            speedup = gbps[names[3]][d] / gbps[names[i]][d]
            if d == 0:
...
def main():
    ...
    schemes = ['TACOS', 'MultiTree', 'TE-CCL', 'SM']
    used_names = ['tacos', 'multitree', 'teccl', 'pipeline']
    total_nodes = 16
    ...
    # folder_names = ['SM_Uni', 'SM_Uni', 'SM_Uni', 'SM_Uni']
    # names = ['tacos', 'multitree', 'teccl', 'sm_uni']
    # draw_graph(ax1[0], schemes, names, folder_names, ldata, xlabels, total_nodes, folder_path, 'AG:$SM_{Uni}$', used_names)
    # folder_names = ['SM_Alter', 'SM_Alter', 'SM_Alter', 'SM_Alter']
    # names = ['tacos', 'multitree', 'teccl', 'sm_alter']
    # draw_graph(ax1[1], schemes, names, folder_names, ldata, xlabels, total_nodes, folder_path, 'AG:$SM_{Alter}$', used_names)
    # folder_names = ['SM_Bi', 'SM_Bi', 'SM_Bi', 'SM_Bi']
    # names = ['tacos', 'multitree', 'teccl', 'sm_bi']
    # draw_graph(ax1[2], schemes, names, folder_names, ldata, xlabels, total_nodes, folder_path, 'AG:$SM_{Bi}$', used_names)

    # folder_names = ['SM_Uni', 'SM_Uni', 'SM_Uni', 'SM_Uni']
    # names = ['tacos', 'multitree', 'teccl', 'sm_uni']
    # draw_graph_ar(ax1[0], schemes, names, folder_names, ldata, xlabels, total_nodes, folder_path, '$SM_{Uni}$', used_names, colors_dict, marker_colors_dict,markers_dict)
    folder_names = ['SM_Alter', 'SM_Alter', 'SM_Alter', 'SM_Alter']
    names = ['tacos', 'multitree', 'teccl', 'sm_alter']
    ...
    # figure.tight_layout()
    figure.savefig('fig_17_bandwidth_fixed_topo.pdf', bbox_inches='tight')
