...
#SBATCH --job-name=sm_bi_scalability_pipeline_build_tree      #Set the job name to "JobExample1"
#SBATCH --time=72:00:00              #Set the wall clock limit to 1hr and 30min
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=4
#SBATCH --mem=32GB                  #Request 2560MB (2.5GB) per node
#SBATCH --output=sm_bi_scalability_pipeline_build_tree.%j
...
outdir=$SIMHOME/results/ISCA2025_10/scalability/SM_Bi
mkdir -p $outdir
