...
class MXNetTreeAllreduce(Allreduce):
    ...
    def backtrack_generate_binary_tree(self, root):
        ...
        # Seek prev-optimal solution until depth <= 3 i.e. 8 accelerators
        # For larger number of accelerators, settle for first tree found (non-prev-optimal),
    ...
    @prev-optimal: whether to find prev-optimal tree or not (True or False)
    ...
    # def iterative_backtrack(state, best_result, best_result_weight, depth, prev-optimal):
