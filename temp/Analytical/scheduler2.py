...
from fatmesh_multitree_all import multitree_2
from fatmesh_multitree_unidirectional import multitree_3
...
multitree_sim, multitree_timesteps = multitree(n1, n2, latencies, num_messages, flits_per_packet, None)
print(multitree_timesteps)
multitree_sim, multitree_timesteps = multitree_2(n1, n2, latencies, num_messages, flits_per_packet, None)
print(multitree_timesteps)
multitree_sim, multitree_timesteps = multitree_3(n1, n2, latencies, num_messages, flits_per_packet, None)
print(multitree_timesteps)
...
#
#
# def run_it(model_size, nodes, total_trees, multitree_timesteps, b):
#     # Configurations:
#
#     chunks = 4  # number of chunks
#     n1 = nodes  # n1 x n2 mesh
#     n2 = nodes
#     # b = 600  # b is the bandwidth
#
#     latencies = get_latencies(b)
#     num_messages = math.ceil((model_size * 4) / message_size)
#     num_messages_fermat_hiererchical = math.ceil(
#         math.ceil(((model_size * 4) / n1) / (total_trees * message_size)) / 2)
#     num_messages_fermat = math.ceil(
#         math.ceil((model_size * 4) / (total_trees * message_size * 3)))
#     num_messages_fermat_v2 = math.ceil(
#         math.ceil(((model_size * 4)) / (total_trees * message_size * 4)))
#     f = open(
...
#               ["Number of fermat messages in Model", str(num_messages_fermat)]]
#
...
#     fermat_hiererchical_sim, fermat_sim, fermat_sim_2 = fermat(n1, total_trees, latencies, num_messages_fermat_hiererchical, num_messages_fermat, num_messages_fermat_v2, flits_per_packet)
...
#     f.write("Fermat Hiererchical All Reduce\t\t\t\t\t" + str(fermat_hiererchical_sim) + "\n")
#     f.write("Fermat All Reduce\t\t\t\t\t" + str(fermat_sim) + "\n")
#     f.write("Fermat All Reduce 2\t\t\t\t\t" + str(fermat_sim_2) + "\n")
