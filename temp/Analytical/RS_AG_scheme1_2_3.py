...
for datasize in data_array:
    ...
    one_dim_uni_list.append(one_dim_unidirectional_result / 2)
    one_dim_bi_list.append(one_dim_bidirectional_result/2)
    two_dim_uni_list.append(two_dim_1_result/2)
    two_dim_bi_list.append(two_dim_2_result/2)
    multitree_list.append(multitree_results/2)
    # tto_list.append(tto_results)
    tto_fatmesh_list.append(tto_fatmesh_results/2)
    multitree_fatmesh_all_list.append(multitree_fatmesh_all_results/2)
    multitree_fatmesh_alternate_list.append(multitree_fatmesh_alternate_results/2)
    multitree_fatmesh_unidirectional_list.append(multitree_fatmesh_unidirectional_results/2)
...
plt.title("RS_AG_nodes_" + str(nodes * nodes))
plt.legend(loc="upper left")
plt.savefig("rs_ag_scheme_1_2_3.png")
